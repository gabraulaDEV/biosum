...
?>
          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              ...
              <form class=div_form action="#">
                ...
                <input style="width: 200px;" type='submit' onClick="mostrarAgregarAdmin()" value='Agregar' />
              </form>
              <hr/>
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">Administradores</h2></div>
    ...
    <script type="text/javascript" src=<?php echo base_url()."assets/admin/js/agregar-admin.js"; ?> ></script>
