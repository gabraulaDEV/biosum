          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden" style="padding: 20px 20px;">
                 ...
                 <form method="POST" action= <?php echo base_url().index_page()."/adminPanel/ofertas/agregaroferta "; ?> >
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" step="0.01" class="form-control" id="porc" name="porc" required="true">
                  </div>
